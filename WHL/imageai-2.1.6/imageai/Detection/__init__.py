    ...
    def detectObjectsFromImage(self, input_image="", output_image_path="", input_type="file", output_type="file",
        ...
        if (self.__modelLoaded == False):
            ...
            try:
                ...
                print(caption)
                cv2.putText(image_copy, caption, (40,60), cv2.FONT_HERSHEY_PLAIN, 2, (255, 100, 0), 2)
                #-----
                ...
                print(caption)
                cv2.putText(image_copy, caption, (40,100), cv2.FONT_HERSHEY_PLAIN, 2, (100, 255, 100), 2)
